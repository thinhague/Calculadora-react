...
## 💻 Projeto
Esse Projeto foi Desenvolvido para praticar conceitos de React.js,hook(useState). O projeto
foi desenvolvido para parecer com a calculadora do Android, com suas funcionalidades básicas.
...
#### Clonando o projeto
```sh
git clone https://github.com/thinhague/Calculadora-react
